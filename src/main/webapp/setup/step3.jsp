        ...
        if (ipaddress != null && port != null && remotepath != null && username != null && password != null
            ...
            if (!ipaddress.trim().equals("") && !port.trim().equals("") && !remotepath.trim().equals("")
                ...
                try {
                    ...
                    Sender.sendMessage(session.getAttribute("c1ipaddress").toString()
                            , Integer.valueOf(session.getAttribute("c1messageport").toString()), "init");
    ...
    <div id="related-activities">
        ...
        <div id="related-act-bottom">
            ...
            <div id="related-act-inner">
                ...
                <div class="right">
                    <h5>This is to setup the communication with the first cloud storage.</h5>
                </div>
                <div class="left"><a href=""><img src="/images/forms/icon_plus.gif" width="21" height="21" alt=""/></a>
                </div>
                <div class="right">
