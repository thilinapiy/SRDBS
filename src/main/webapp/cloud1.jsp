...
<%@ page import="java.io.*" %<%
    ...
    if (session.getAttribute("username") == null) {
		...
		if (ipaddress != null && port != null && remotepath != null && username != null && password != null
			...
			response.sendRedirect("/cloud1.jsp");
            return;
			}
			}
...
<FORM action="cloud1.jsp" method="get">  
<H2><LEFT>UPDATE CLOUD 1 DETAILS</LEFT></H2>  
  ...
  <table border="1" width="300" height="150">
									...
									<%
                                        try {
                                            ...
                                            Connection connection = new DbConnect().webDbConnect();
                                            Statement statement = connection.createStatement();
                                            String QueryString = "SELECT sysvalue from sysconfig where sysid='5'";
                                            ResultSet rs = statement.executeQuery(QueryString);
									...
									<%
                                        try {
                                            ...
                                            Connection connection = new DbConnect().webDbConnect();
                                            Statement statement = connection.createStatement();
                                            String QueryString = "SELECT sysvalue from sysconfig where sysid='6'";
                                            ResultSet rs = statement.executeQuery(QueryString);
									...
									<%
                                        try {
                                            ...
                                            Connection connection = new DbConnect().webDbConnect();
                                            Statement statement = connection.createStatement();
                                            String QueryString = "SELECT sysvalue from sysconfig where sysid='7'";
                                            ResultSet rs = statement.executeQuery(QueryString);
									...
									<%
                                        try {
                                            ...
                                            Connection connection = new DbConnect().webDbConnect();
                                            Statement statement = connection.createStatement();
                                            String QueryString = "SELECT sysvalue from sysconfig where sysid='9'";
                                            ResultSet rs = statement.executeQuery(QueryString);
...
<TABLE  WIDTH="30%" >  
                    <tr>  
                        <td> IP Address : </td><td> <input name="ipaddress" size=20 type="text" /> </td>   
                    </tr>  
                    <tr>  
                        <td> Port : </td><td> <input name="port" size=20 type="text" /> </td>   
                    </tr>  
                    <tr>  
                    ...
                    <tr>  
                        <td> Remote Path  : </td><td> <input name="remotepath" size=20 type="text" /> </td>   
                    </tr>  
                    <tr>  
                        <td> messageport  : </td><td> <input name="messageport" size=20 type="text" /> </td>   
                    </tr>  
					<tr>
					    <td colspan="1">
